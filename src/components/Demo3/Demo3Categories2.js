        ...
        >
            <div className="container">
                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="section-title mb-10">
                            {/* Title 	*/}
                            <h4 className="h4-xl">Expansion And Finance</h4>
                ...
                <div className="row d-flex align-items-center">
                    ...
                    <p>
                        To provide maximum facilities to the public of this region, the Board has been liberally acceding to the public demand for opening new centers for the examination. Almost every year the new examination centers are established. <br/> BISE Sukkur is leading towards self sufficiency and have to meet their revenue as well as capital demands from examination fees, which is its only source of income. By exercising extreme financial control,
                        adopting strict economy measures and making liabilities on staff and equipment, i.e. to grow step by
                        step with the requirements, the Board has been able to transfer sufficient funds to the development
                        budget.
                    </p>
                    </div>
                    <div className="col-md-7 col-lg-6" >
                        <div className="img-block">
                            <img
                                className="img-fluid"
                                src="images/animatedimges/finance.png"
                                alt="about-image"
                                width='80%'
                            />
                        </div>
